...
(function(h) {
    ...
    function pb(a) {
        ...
        for (
            var f = a.sDom.split(""), g, j, i, n, m, q, k = 0; k < f.length; k++
        ) {
            g = null;
            j = f[k];
            if ("<" == j) {
    ...
    function Ab(a) {
        for (
            var b = l.ext.search, c = a.aiDisplay, d, e, f = 0, g = b.length; f < g; f++
        ) {
                    ...
                    return bb(
                        ...
                        function(a) {
                            ...
                            if (a.nodeName) {
                                ...
                                if (n)
                                    return i[n.row] &&
                                        i[n.row].nTr === a.parentNode ? [n.row] : [];
                    ...
                    if (C(g, "_details").length > 0) {
                        ...
                        f.on(
                            ...
                            function(a, b) {
                                if (e === b)
                                    for (
                                        var c, d = W(b), f = 0, h = g.length; f < h; f++
                                    ) {
                                        c = g[f];
                                        c._details &&
                                            c._details
    ...
    l.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "لاتوجد مزادات خاصة بك",
