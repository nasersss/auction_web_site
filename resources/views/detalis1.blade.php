...
<body>
  <div class="row row-cols-4" id="detalis">
    <div class="col-4">
        <img  src="assets/images/mobile_listing_main_04 (1).jpg">
        <img class="img-fluid" src="assets/images/2022-mercedes-benz-cls-450-4matic-driver-side-interior.jpg">
    </div>
    
    <div class="col-8">
    <img class="img-fluid" src="assets/images/e-class-coupe-brilliant-blue-metallic.jpg" alt="" />
    </div>
...
<table class="table custom-table">
  <thead>
    <tr>  
      ...
      <th scope="col">هيكل المركبة</th>
      <th scope="col"> الوصف</th>
      <th scope="col">معلومات أساسية</th>
    </tr>
  </thead>
  <tbody>
    <tr scope="row">
      ...
      <td>
      مرسيدس بنز
        <small class="d-block">مستعملة 2020 مرسيدس بنز GLE 43 AMG Coupe عائلية</small>
      </td>
      <td>2020</td>
      <td>عام</td>
    </tr>
