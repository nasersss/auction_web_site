                    ...
                    <div class="card-body">
                        ...
                        <form action="#">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="email" id="emailaddress" required="" placeholder="ادخل بريدك الاكتروني">
                            </div>
                            <div class="mb-3">
                                <label for="password" class="form-label">كلمة المرور</label>
                                <input class="form-control" type="password" required="" id="password" placeholder="ادخل كلمة المرور">
                                <a href="pages-recoverpw-2.html" class="text-muted float-end"><small>هل نسيت كلمة المرور؟</small></a>
                            </div>

                            <div class="mb-3">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input checkBox" id="checkbox-signin">
                        ...
                        <footer class="footer footer-alt">
                            <p class="text-muted">لا تمتلك اي حساب قم بانشاء حسابك الان ؟ <a href="pages-register-2.html" class="text-muted ms-1"><b>انشاء حساب</b></a></p>
                        </footer>
