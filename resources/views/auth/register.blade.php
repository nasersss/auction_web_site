                    ...
                    <div class="card-body">
                        ...
                        <form action="#">
                            <div class="mb-1">
                                ...
                                <input class="form-control" type="text" id="fullname" placeholder="ادخل اسمك الكامل" required>
                            </div>
                            <div class="mb-1">
                                <label for="emailaddress" class="form-label">البريد الالكتروني</label>
                                <input class="form-control" type="email" id="emailaddress" required placeholder=" ادخل البريد الالكتروني الخاص بك">
                            </div>
                            <div class="mb-1">
                            ...
                            <div class="mb-1">
                                ...
                                <input class="form-control" type="confirm-password" required id="password" placeholder="تاكيد كلمة المرور ">
                            </div>
                            <div class="mb-1">
