                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="card shadow-none m-0 border-start">
                            <div class="card-body text-center">
                                ...
                                <h3><span>@isset($orders){{count($orders)}} @else 0 @endisset</span></h3>
                                <p class="text-muted font-15 mb-0">المزادات المكتملة</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="card shadow-none m-0 border-start">
                            <div class="card-body text-center">
                                ...
                                <h3><span>@isset($users){{count($users)}} @else 0 @endisset</span></h3>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="card shadow-none m-0 border-start">
                            <div class="card-body text-center">
                                ...
                                <h3><span>@isset($bayders){{count($bayders)}}@else 0 @endisset</span> <i class="mdi mdi-arrow-up text-success"></i></h3>
                                <p class="text-muted font-15 mb-0">عدد المشاركات في المزادات </p>
                            </div>
                        </div>
                    </div>
