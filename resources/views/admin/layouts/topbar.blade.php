                        ...
                        <div style="max-height: 230px;" data-simplebar="">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <div class="notify-icon">
                                    <img src="assets/images/users/avatar-11.jpg" class="img-fluid rounded-circle" alt=""> </div>
                                <p class="notify-details">فؤاد العمودي</p>
                ...
                <li class="dropdown notification-list">
                    <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                    <span class="account-user-avatar">
                                        <img src="{{asset('assets/images/users/avatar-11.jpg')}}" alt="user-image" class="rounded-circle">
                                    </span>
                        <span>
                                        <span class="account-user-name">فؤاد العمودي</span>
                                        <span class="account-position">مسؤول النظام</span>
                                    </span>
                    </a>
